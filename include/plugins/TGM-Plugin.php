<?php if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				'page_title'                      => __( 'Automatic plugin installer', 'tgmpa' ),
				'menu_title'                      => __( 'Auto install', 'tgmpa' ),
		...
		public function install_plugins_page() {
            ...
            <div class="tgmpa wrap">
                <h1><?php echo esc_html( get_admin_page_title() ); ?></h1> <?php $plugin_table->prepare_items(); ?> <?php if ( ! empty( $this->message ) && is_string( $this->message ) ) {
					echo wp_kses_post( $this->message );
				} ?> <?php $plugin_table->views(); ?>
                <form id="tgmpa-plugins" action="" method="post"><input type="hidden" name="tgmpa-page"
                                                                        value="<?php echo esc_attr( $this->menu ); ?>"/>
                    <input type="hidden" name="plugin_status"
                           value="<?php echo esc_attr( $plugin_table->view_context ); ?>"/> <?php $plugin_table->display(); ?>
                </form>
            </div> <?php }
