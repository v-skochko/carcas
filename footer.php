...
<footer >
    <div class="row cfx">
        ...
        <div class="social_link">
            ...
            <a href="<?php if (get_field('google', 'options')) {the_field('google', 'options'); } else {echo "https://plus.google.com/"; } ?>" class="i-g"  title="Official Instagram accounts" target="_blank"></a>
            ...
            <a href="<?php if (get_field('linkedin', 'options')) {the_field('linkedin', 'options'); } else {echo "https://www.linkedin.com/"; } ?>"   class="i-linkedin" title="Official Linkedin profile" target="_blank"></a>
            <a href="<?php if (get_field('youtube', 'options')) {the_field('options', 'options'); } else {echo "https://www.youtube.com/"; } ?>"  class="i-youtube-play" title="Official Youtube channel"  target="_blank"></a>
        </div>
    </div>
</footer>
<?php wp_footer(); ?>
